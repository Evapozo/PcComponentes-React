...
function App() {
  ...
  function changeNombre(ev){
    ...
    setNombreUsuario(ev.target.value); //llamo a la funcion modificadora d esta variable del state y asigno un nuevo valor
  ...
  return (
    ...
    */}
    <div className = "m-4">
      ...
      <div className = "m-4">
      <label className= "form-label" htmlFor="inputNombre">Email: {email} </label>
      <input type = "text"
              id = "inputEmail"
              className = "form-control"
              placeholder = "Email*"
      ...
      <div className = "m-4">
      <label className= "form-label" htmlFor="inputNombre">Password: {password} </label>
      <input type = "text"
              id = "inputPassword"
              className = "form-control"
      ...
      <div className = "m-4">
      <label className= "form-label" htmlFor="inputNombre">RePassword: {repassword} </label>
      <input type = "text"
              id = "inputPassword"
              className = "form-control"
